# NBC Notion Map — Page IDs, Databases, Scenarios, Schema

All IDs verified 2026-07-28 via Notion MCP. Fetch any page with `notion-fetch` using the ID.

## Core pages

| Page | ID | What's on it |
|---|---|---|
| ⚾ NBC — Northside Baseball Club (Demo) — **project hub** | `a0bc8520-34de-483e-97a5-61cb80707d58` | Latest News & Review callout, Suggested Next Steps callout, inline Milestones/Meetings/Deliverables/Time Entries views, Project Updates toggle, Project Overview callout |
...
| 🎬 NBC Demo Playbook & Reset Guide | `e6e8430a-c5fc-46a4-97b3-04f1e1c1c18b` | 6 demo scenarios, reusability rules, quick reset reference table, **🎬 Staging Log section at the bottom** (snapshot entries written/consumed by the Stage and Strike workflows) — read before/after any demo that changes state |
| 💽 Data Resource Index — NBC | `3abe74c6-9c18-8196-8dd4-e97a8b0141d9` | Source status table (AXS/Salesforce/QuickBooks/Sponsorship), links to all agent instruction pages |
| 🤖 Claude Agent Instructions — NBC Semantic Model Build | `3abe74c6-9c18-81f3-871c-ed7762cc2030` | Priority callouts, DAX autonomy directive, **Verified Model State (the de facto data dictionary)**, MCP tool table, validation DAX queries |
...
| Fabric Notebook Instructions — NBC PySpark | `3abe74c6-9c18-8118-a66b-c69f0bd23eb3` | Bronze/silver/gold notebook standards |
...
Note: there is no standalone "NBC Data Dictionary" page — the verified 18-table model state lives in the Agent Instructions page above.

## Milestones (P1–P7)

Rows in the shared 🌎 Milestones database, related to the NBC hub. Default demo statuses below; if a fetch shows something else, a demo probably wasn't reset.

| # | Milestone | Page ID | Default status | Best for demoing |
|---|---|---|---|---|
| P1 | NBC — Semantic Model & Power BI Reporting | `4ad32eae-c9d2-49c8-ae1d-ef147d84da49` | Active/Ongoing | Semantic modeling, DAX measures, Power BI sandbox sessions |
| P2 | NBC — Fabric Data Platform | `08ba18dd-9197-4b19-a4f4-8709196649f0` | Active | Fabric lakehouse, pipeline ingestion, multi-source architecture |
| P3 | NBC — BI Modernization Roadmap | `649c7def-66ec-48ff-a1af-8fd9fa5f1c2b` | **NOW** | Discovery phase, architecture decisions, 3-year roadmap story |
| P4 | NBC — Operations & Event P&L Dashboard | `7e62df11-05fd-43c5-b3f5-c5ea128460ea` | Active | Financial dashboard, event-level P&L, ops reporting |
| P5 | NBC — MCP Integration & AI Tooling | `638ecf0a-64f4-441e-90dd-519c8524347a` | Active | MCP server build, Notion AI agent setup, NLQ→DAX |
| P6 | NBC — Season Ticket Holder CRM Analytics | `0a55bfd5-3f39-4989-b63b-6912aa39a371` | Ongoing | CRM analytics, churn prediction, renewal pipeline |
| P7 | NBC — Fabric Notebooks & Medallion Architecture | `4bb16c87-b0ac-4f47-abc5-bcb429ba1dd2` | Active | Bronze/silver/gold layers, PySpark notebooks, DirectLake |

## Databases and data sources

These are shared workspace databases; NBC views filter on the relation `⚾ ProjectsConsulting` containing the hub URL.

| Database (NBC view) | Database ID | Data source (SQL table name) |
|---|---|---|
...
NBC milestones with status, in priority order:
...
**Example measures used in NBC content:** `This Game Revenue`, `Prior Game Revenue`, `Game over Game Revenue %`, `Season to Date Revenue`, `Section Utilization %`, `Yield per Seat`, `Trailing 5 Game Avg Attendance`. Currency = zero decimals; percentages = 1 decimal.
