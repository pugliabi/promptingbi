...
I will indict myself here rather than a hypothetical junior, because I am living in this exact gap. Agents are building applications for me right now, local things for my own use. I could not sit down at a blank file and write one. I do not even pick the language: sometimes C#, more often JavaScript and npm packages I have never heard of. That was the agent's call, not mine, and I am not going to pretend I could judge it. Agents wrote that code. I direct it, and I direct it reasonably well, because I have spent years learning how to specify and evaluate work in general.

But notice the escape hatch I have: nobody is making a hiring decision based on a number that code produced. A junior shipping DAX does not get that hatch. Their output goes to a CFO as a figure somebody will act on.
