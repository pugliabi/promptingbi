...
![A company approaching a diagnostic checkpoint gate before a winding adoption roadmap, where the passing path continues onto the road and the failing path loops back to a whiteboard of undefined goals](/images/2026/07/step-zero-roadmap-test.png)
...
- **Data literacy**: the ability to read data and know what to ask for. I can define my metrics, so I can communicate them. Sales leads, marketing leads: we all agree on what those words mean.
