...
Fair enough. This post is the tour. It's the organized-context part of the two-harness loop: this one covers the hub, the next introduces **my assistants**, the agents that keep the whole thing honest, and then the **MCP execution session**.
