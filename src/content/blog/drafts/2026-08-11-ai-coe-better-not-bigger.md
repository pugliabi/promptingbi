...
permalink: "2026/08/11/ai-coe-better-not-bigger"
draft: true
...
Here's my position: AI can absolutely help your Center of Excellence. That part isn't even a debate worth having. The debate is whether you can prove it made your CoE **better** and not just **bigger**. Because those are two very different outcomes, and the second one is the default.

## Content Is Not Impact

Let me say the quiet part first. Just because AI is creating content does not mean it is creating impact.
...
This is the trap. A pile of documents that nobody reads is not a Center of Excellence. It's a landfill with a table of contents. And I'd go further: if the content isn't helpful, you're better off not having it at all. Documentation that means nothing to anyone actively erodes trust in the whole knowledge center, because the one time someone does open it and finds generic nonsense, they never come back.

Bigger is easy now. Bigger is basically free. Which means bigger is worth nothing on its own.
...
When I started riding, I was on an old aluminum bike, and my times were what they were. I knew that if I invested in a real bike, I'd see a genuine, measurable jump. And I did. But here's the thing: now that I'm riding decent equipment, spending the same money again on an even better bike buys me almost nothing. The huge gains live at the bottom of the curve, not the top.
...
But that also means you have to ask the uncomfortable investment questions before you start. How much is this actually going to cost? And what marginal impact will it make? If the answer is a five-figure agentic platform to shave a rounding error off a CoE that's already functioning, that's not a strategy. That's buying a second carbon bike.

## There Are Levels to This

The Fabric adoption roadmap gives maturity levels for governance, mentoring, content delivery, all of it. I think applying AI to your Center of Excellence deserves the same treatment, because "we're using AI in our CoE" means absolutely nothing on its own. Here's how I break down the levels.
...
**Level one is the MCP.** Connect an agent to your semantic models through an MCP server and put it to work on the mechanical layer: does every column have a description, does every measure have a description, can you trace lineage from the gold layer through the model to the report. This is the baseline for a reason. It's a general staple you can apply to ANY semantic model in any organization, it's slow and miserable to do by hand, and an agent chews through it without complaint. If you do nothing else, do this.

But hear me out: level one is a foundation, not a destination. Writing descriptions and scooting around your tenant is nice. It is not what makes a Center of Excellence matter.
...
And I'll say the harsh version plainly. If you do not have a baseline, and you do not have goals for your CoE that exist independently of AI, don't do AI yet. You will not be able to see anything impactful. You'll just make the thing bigger, congratulate yourself, and blow the investment. The goals come first; AI is how you accelerate toward goals you already had.

I keep coming back to something Steve Jobs said: focus is about saying no. Never more relevant than right now. You could throw AI at everything in your Center of Excellence and you would absolutely get results, in the sense that stuff would get produced. Whether any of it matters is a different question. Some of it you'll eventually have to kill because it does nothing. Pick the pain points. Pick the processes that map to your company and your culture. Say no to the rest.

## Where to Start This Quarter

If I were standing up an agentic CoE effort from scratch, here's the order of operations:

1. **Baseline first.** Grade your CoE against the Fabric adoption roadmap's maturity levels, section by section. Write down where you're weak. No AI involved yet.
2. **Confirm the goals already exist.** Tickets resolved faster, users migrated, self-service adoption, whatever your CoE was already supposed to achieve. If there are no goals, stop and fix that.
3. **Deploy level one.** Agent plus MCP against your semantic models: column descriptions, measure descriptions, lineage. The general staple. Immediate, visible, cheap.
4. **Recruit the business.** Get operations, sales, finance to hand over their real process docs and definitions, and build agent skills from them. This is the step that separates a CoE that knows your company from one that could belong to anyone.
5. **Measure against the baseline.** Same roadmap sections, same KPIs, one quarter later. Better, or just bigger? Now you can actually answer.

## The Question That Keeps You Honest

Here's my prediction: within a couple of years, every Center of Excellence pitch deck will lead with AI, and most of those CoEs will be enormous and useless. The teams that win will be the ones who treated "did it get better?" as a measurable question instead of a vibe.

**Key takeaway:** before you point one more agent at your Center of Excellence, write down your baseline this week. Grade yourself against the Fabric adoption roadmap, pick the ONE weakest area, and aim your first agentic investment there. One level up. That's the race.
